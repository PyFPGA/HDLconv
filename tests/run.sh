...
python3 ../hdlconv/vhdl2vhdl.py --filename conv1.vhdl --top Counter hdl/vhdl/counter.vhdl
...
python3 ../hdlconv/vhdl2vlog.py --backend yosys --filename conv5.v --top Counter \
...
python3 ../hdlconv/slog2vlog.py --filename conv7.v --top Counter \
  hdl/slog/counter.sv
...
python3 ../hdlconv/slog2vlog.py --frontend synlig --filename conv9.v --top Counter \
  hdl/slog/counter.sv
...
python3 ../hdlconv/slog2vlog.py --frontend yosys --filename convB.v --top Counter \
  hdl/slog/counter.sv
